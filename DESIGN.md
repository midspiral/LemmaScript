...
```
  ...
  with //@ annotations
       ...
       │                   │
       │                   └──→ pe  (structural narrowing → someMatch)
       │                             │
...
design choices in the resolve/pe/transform split, and
