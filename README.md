...
- **[casbin-lemmascript](https://github.com/midspiral/casbin-lemmascript/)** — brownfield verification of the [node-casbin](https://github.com/casbin/node-casbin) access control library. 5 functions verified (effector, keyMatch, keyGet, arrayEquals), 217 existing tests pass with verified code wired in.
