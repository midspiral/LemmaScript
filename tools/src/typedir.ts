...
/** Builtin identity assigned once by resolve (DESIGN_LS_IN_LS.md §3):
 *  present on a call node iff `(receiver type kind, method name)` matched
 *  the registry at resolve time. Downstream passes read classification off
 *  the stamp instead of re-recognizing by spelling. */
export type { BuiltinId } from "./builtins.js";
...
export type TChainStep =
  ...
  | { kind: "call"; args: TExpr[]; ty: Ty; callKind: CallKind;
      builtinId?: import("./builtins.js").BuiltinId }
